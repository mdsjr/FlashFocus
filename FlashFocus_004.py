...
def exibir_palavras():
    ...
    for palavra in palavras:
        ...
        texto_exibicao = f"{parte1}{letra_central}{parte2}"


        label_palavra.config(text=texto_exibicao)
        # Configuração adicional para habilitar tags HTML no Label
        label_palavra.config(wraplength=300) # Ajuste conforme necessário
        label_palavra.config(justify='center')
        janela.update()
        time.sleep(0.3)
